          ...
          <div className="bg-[#B8D68F]/25 rounded-[10px] py-10 sm:py-16 mx-4 sm:mx-10 lg:mx-16 px-4 sm:px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start max-w-[1050px] mx-auto">
              ...
              <div className="text-left text-[#3A5B40] md:-ml-4 lg:-ml-16">
                ...
                <div className="flex flex-nowrap gap-3 mt-8 overflow-x-auto sm:overflow-visible">
                  <button
                  ...
                  <button
                    onClick={handleAction}
                    className="flex items-center justify-center bg-[#3A5B40] text-white text-[11px] sm:text-[13px] font-semibold px-3 sm:px-6 py-2 rounded-[10px] min-w-[120px] sm:min-w-[230px] hover:bg-[#486947] transition"
                  >
                    Pesan Sekarang
                  </button>
                </div>
