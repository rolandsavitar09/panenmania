...
// Banner gambar katalog (pakai aset yang sama)
import CatalogBanner from "../../assets/images/banners/petani katalog.svg";
// Icon search – sama dengan before login
...
// Dummy data produk (sama seperti before-login, sudah diberi category)
const PRODUCTS = [
  {
...
function CatalogAfterLogin() {
  ...
  return (
    <div className="font-poppins bg-[#F8FAF7] min-h-screen flex flex-col pt-14">
      ...
      {/* SEARCH BAR – sama persis dengan CatalogBeforeLogin */}
      <section className="flex justify-center items-center py-10">
        <form
          onSubmit={handleSearchSubmit}
          className="w-full flex justify-center"
        >
          {/* wrapper w-1/2 biar pas sama HomeContent & beforeLogin */}
