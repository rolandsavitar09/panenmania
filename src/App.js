...
const Private = ({ children }) => (isLoggedIn() ? children : <SignIn />);
...
function App() {
  return (
    <Routes>
      ...
      <Route
        path="/"
        element={isLoggedIn() ? <HomePageAfterLogin /> : <HomePageBeforeLogin />}
      />
      ...
      <Route path="/product-before/:id" element={<ProductDetailBeforeLogin />} />

      {/* After Login */}
      <Route path="/home" element={<Private><HomePageAfterLogin /></Private>} />
      <Route path="/catalog/login" element={<Private><CatalogAfterLogin /></Private>} />
      <Route path="/about/login" element={<Private><AboutAfterLogin /></Private>} />
      <Route path="/contact/login" element={<Private><ContactAfterLogin /></Private>} />
      <Route path="/product/:id" element={<Private><ProductDetailAfterLogin /></Private>} />
      ...
      {/* Profile & Orders */}
      <Route path="/profile" element={<Private><ProfileMain /></Private>} />
      <Route path="/profile/address" element={<Private><ProfileAddress /></Private>} />
      <Route path="/profile/password" element={<Private><ProfilePassword /></Private>} />
      <Route path="/orders-status" element={<Private><OrderStatus /></Private>} />
      <Route path="/orders-history" element={<Private><OrderHistory /></Private>} />
      <Route path="/orders-history/:orderId" element={<Private><OrderHistoryDetail /></Private>} />
    </Routes>
  );
}
